...
repository](https://github.com/IBM/watson-nao-robot).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/watson-nao-robot/issues). Before embarking on 
...
issue](https://github.com/IBM/watson-nao-robot/issues) before sending a pull
...
(https://github.com/IBM/watson-nao-robot/issues).
